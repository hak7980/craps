...
x <- tibble(
  ...
  p1 = map_int(1:100000, ~ roll_two_dice()),
                            
            p2 = (map_int(1:100000, ~ roll_two_dice()
...
x <- x %>%
  ...
  mutate(first_win = ifelse(tie ==1, 0,1)) %>%
  
  mutate(second_win = ifelse(tie ==1, 0,1))
